...
// use crate::{resources::dto::fullstack_extension::AppExtension, utils::jwt::authenticate};
// use axum::{
...
//         Some(header) if header != "utoipa-rocks" => Err(AppError::new(
//             StatusCode::UNAUTHORIZED,
//             "incorrect api key",
//             None,
//         )),
//         None if require_api_key => Err(AppError::new(
//             StatusCode::UNAUTHORIZED,
//             "missing api key",
//             None,
//         )),
